...
(function () {
   ...
   //获取当前网址，如： http://localhost:8083/uimcardprj/share/meun.jsp
    ...
    //访问图片的路径
    var ownImagePath = localhostPaht;
    var projectName=pathName.substring(0,pathName.substr(1).indexOf('/')+1);
    //访问附件的路径
    var ownFilePath = "http://img.moreccc.com/";
    //var ownImagePath = "http://localhost:8080/keywaManager/";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:localhostPaht+"/servlet/ueUpload"             //图片上传提交地址
        ,imagePath:ownImagePath                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,scrawlPath:ownImagePath                     //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
        ,filePath:ownFilePath                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"jsp/getRemoteImage.jsp"   //处理远程图片抓取的地址
        ,catcherPath:ownImagePath                  //图片修正地址，同imagePath
        ...
        ,imageManagerPath:ownImagePath                      //图片修正地址，同imagePath
        ...
        //附件:'attachment' 表格:'inserttable', 'deletetable', 'insertparagraphbeforetable','insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
        , toolbars:[
            [ 'fullscreen','source','|','undo', 'redo', '|',
                ...
                'link', 'unlink', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|','attachment',
                'inserttable', 'deletetable', 'insertparagraphbeforetable','insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
                'insertimage', '|',
                'horizontal', 'date', 'time', 'spechars', 'wordimage','insertcode']
        ]
...
//        ,maxListLevel : 3 //限制可以tab的级数-1不限制
        ...
        ,'fontfamily':[
            ...
            { label:'Georgia',name:'georgia',val:'georgia'},
          ]
...
//                }
           ...
           // {
           //     label:'插入段落',       //显示的名称
           //     cmdName:'insertparagraph',//执行的command命令，当点击这个右键菜单时
           // },
           // {
           //     label:'撤销',       //显示的名称
           //     cmdName:'undo',//执行的command命令，当点击这个右键菜单时
           // },
           // {
           //     label:'插入日期',       //显示的名称
           //     cmdName:'date',//执行的command命令，当点击这个右键菜单时
           // },
           // {
           //    label:'插入时间',       //显示的名称
           //     cmdName:'time',//执行的command命令，当点击这个右键菜单时
           // },
           // {
           //     label:'预览',       //显示的名称
