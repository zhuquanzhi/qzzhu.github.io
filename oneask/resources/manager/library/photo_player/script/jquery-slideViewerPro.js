...
jQuery(function(){
   jQuery("div.svwp").prepend("<img src='photo_player/images/svwloader.gif' class='ldrgif' alt='loading...'/ >"); //change with YOUR loader image path   
});
var j = 0;
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			asTimer: 4000,
			thumbs: 5,
			thumbsPercentReduction: 19,
			thumbsVis: true,
			easeFunc: "easeInOutExpo",
			leftButtonInner: "<img src='photo_player/images/prev.png' />", //could be an image "<img src='images/larw.gif' />" or an escaped char as "&larr";
			rightButtonInner: "<img src='photo_player/images/next.png' />", //could be an image or an escaped char as "&rarr";
			autoslide: true,
			typo: false,
			typoFullOpacity: 0.7,
			shuffle: false
