	...
	<div id="left_layout">
		...
		<div id="main_content" class="container-fluid">
			<ul class="breadcrumb breadcrumb-main">
				...
				<li class="text-info">权限新增</li>
			</ul>
			<div class="h4-bigger">
				<h2 id="target-new">
					<i class="icon-minus i-rotate-d"></i>权限新增
				</h2>
			</div>
			<!-- post wrapper -->
			<form class="myform" action="${ctx}/manager/security/permission/save" method="post">
				<div class="well widget">
					<div class="excerpt">
						...
						<div class="excerpt-span-long">
							<label class="text-success"><font class="index_pages_redcolor">*</font>权限编码：</label> <span class="input-pro-det"><input type="text" class="input-large validate[required,maxSize[50]]" name="permission.permission" value="${permission.permission}">如：user:add </span>
						</div>
					</div>
				</div>
				<input class="btn btn-info" type="submit" value="新增"> <input class="btn btn-ay" type="button" value="取 消" onclick="javascript: history.back(-1)">
			</form>
			<!-- ./ post wrapper -->
		</div>
		<!-- end main content -->
