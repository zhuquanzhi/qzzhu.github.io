	...
	<div id="left_layout">
		...
		<div id="main_content" class="container-fluid">
			<ul class="breadcrumb breadcrumb-main">
				...
				<li class="text-info">用户编辑</li>
			</ul>
			<div class="h4-bigger">
		      <h2 id="target-new"><i class="icon-minus i-rotate-d"></i>用户编辑</h2>
		    </div>
		    <!-- post wrapper -->
		    <form class="myform" action="${ctx}/manager/security/user/update" method="post">
		    ...
		    <div class="well widget clearfix">		    
		    	<div id="accordion" class="panel-group">
		    		<div class="panel panel-default">
						...
						<div id="collapse-one" class="panel-collapse in">
									...
									<div class="span6-b left">
										<div class="excerpt excerpt-wid clearfix" >
											<span class="excerpt-span">
												...
												<span class="input-pro-det"><input class="span3" type="text" name="user.username" value="${user.username}" readonly="readonly"/></span>
											</span>
											<span class="excerpt-span">
						                        <label class="text-success">用户姓名：</label>
												<span class="input-pro-det"><input class="validate[required,maxSize[50]] span3" name="user.fullname" type="text" value="${user.fullname}"/></span>
						                    </span>
										</div>
									</div>
									<div class="span6-b right">
										<div class="excerpt clearfix">
											<span class="excerpt-span">
												...
												<span class="input-pro-det"><input class="validate[required,maxSize[128]] span3" type="password" id="password" name="newPassword" value="${user.password}"/></span>
											</span>
											<span class="excerpt-span">
						                        <label class="text-success">密码确认：</label>
												<span class="input-pro-det"><input class="validate[required,maxSize[128],equals[password]] span3" type="password" value="${user.password}"/></span>
						                    </span>
										</div>
									</div>
								</div>
            	...
            	<div id="accordion" class="panel-group">
		    		<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a href="#collapse-two" data-parent="#accordion" data-toggle="collapse"> 状态信息<i class="icon-chevron-down right panel-title_icon-color"></i></a>
							</h4>
						</div>
						<div id="collapse-two" class="panel-collapse in">
							<div class="panel-body">
								<div id="accorder_b" class="info_content_big">								
									<div class="excerpt excerpt-wid clearfix">
										<span class="excerpt-span">
											...
											<span class="input-pro-det">
											 	<label class="radio"><input type="radio" name="user.status" value="1" class="fancy" <c:if test="${'1' eq user.status}">checked="checked"</c:if> />激活</label>
						                    	<label class="radio"><input type="radio" name="user.status" value="0" class="fancy" <c:if test="${'0' eq user.status}">checked="checked"</c:if> />禁用</label>
											</span>
										</span>
									</div>									
								</div>
								...
								<div id="accorder_b" class="info_content_big info_info_02 clearfix open_mdpadding">								
									<table  cellspacing="0" cellpadding="0" border="0" align="left" width="480">
										...
										<tr>
											...
											<td colspan="4">
												<select id="Select2" multiple="multiple" class="validate[required] sel_box01" name="roleIds" size="10">
												<c:forEach items="${userRoles}" var="role"><option value="${role.id}" selected="selected">${role.name}</option></c:forEach>												
												</select>
											</td>
										</tr>
									</table>
