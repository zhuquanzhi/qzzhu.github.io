...
<div id="left_layout">
  ...
  <div id="main_content" class="container-fluid">
    <ul class="breadcrumb breadcrumb-main">
      ...
      <li class="text-info">标签列表</li>
    </ul>
    <div class="index_marginBottom">
      <span class="in-dfyq-gl-span-mtb">标签名称：
    ...
    <div class="well widget">
      <div class="widget-header">
        ...
        <span class="right in_wh_r">
          <a href="${ctx}/manager/business/tag/create" class="btn">
        	...
        	<c:forEach items="${page.list}" var="item">
	          <tr>
	            ...
	            <td>
	              ...
	              <a href="${ctx}/manager/business/tag/edit?id=${item.id}" class="in_Font_color">
	                <i class="icon-edit"></i>
	              </a>
	            </td>
	          </tr>
